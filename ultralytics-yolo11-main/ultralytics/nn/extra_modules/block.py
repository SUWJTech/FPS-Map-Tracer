...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C3k2_Faster', 'C3k2_ODConv', 'Partial_conv3', 'C3k2_Faster_EMA', 'C3k2_DBB',
           ...
           'C3k2_CSSC', 'C3k2_CNCM', 'C3k2_HFRB', 'C3k2_EVA', 'C3k2_RMBC', 'C3k2_RMBC_LA', 'C3k2_IEL', 'C3k2_SFMB', 'FSConv', 'MFPM', 'ERM', 'C3k2_MFEB', 'C3k2_PartialNetBlock', 'C3k2_DRG', 'C3k2_GLGM', 'C3k2_MAC', 'C3k2_SPJFB', 'C3k2_GLSS2D', 'C3k2_DEGConv', 'C3k2_TransMixer', 'C3k2_PFG',
           'C3k2_MSInit', 'C3k2_SMB', 'C3k2_SMS', 'C3k2_DSEBlock', 'C3k2_LaSEA', 'C3k2_SFEB', 'C3k2_FourierSR', 'C3k2_FrequencyCM'
           ]
...
class C3k_MFEB(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(MFEB(c_, c_) for _ in range(n)))

class C3k2_MFEB(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_MFEB(self.c, self.c, 2, shortcut, g) if c3k else MFEB(self.c, self.c) for _ in range(n))
...
######################################## TIP2026 FourierSR end ########################################

######################################## CVPR2026 UCMNet start ########################################
